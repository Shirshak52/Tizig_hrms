...
def create_app():
    ...
    with app.app_context():
        ...
        # Version the Employee model
        from sqlalchemy_continuum import version_class
        SalaryHistoryVersion = version_class(SalaryHistory)
        ...
        from app.views.salary_history_view import SalaryHistoryVersionAdminView
        ...
        administrator.add_view(SalaryHistoryVersionAdminView(SalaryHistoryVersion, db.session))  # Set up SalaryHistory CRUD views
